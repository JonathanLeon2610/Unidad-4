...
<body>
    ...
    <div class="modal-dialog">
        ...
        <form method="post" action="../app/ChargeProductController.php">}
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" name="brand_id">
            </div>
            </div>
                        ...
                        <div class="card bg-light " style="width: 20rem;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <a href="details.php" class="btn btn-info mt-2">Detalles</a>
                                </div>
                            </div>
                        </div>
                    </div>
